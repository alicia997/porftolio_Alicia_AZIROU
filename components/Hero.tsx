...
>
  ...
  <div className="mt-5 h-1 w-20 rounded-full bg-accent/80" />
          ...
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, delay: 1.6, ease: easeOutExpo }}
            className="mt-10 flex flex-wrap items-center justify-center gap-4"
          >
            <Magnetic>
              <button
                onClick={() => scrollTo("#projets")}
                className="group flex items-center gap-2 rounded-full bg-foreground px-6 py-3.5 text-sm font-semibold text-background transition-all hover:gap-3 hover:shadow-lg"
              >
            ...
            <Magnetic>
              <button
                ...
                className="flex items-center gap-2 rounded-full border border-border-strong px-6 py-3.5 text-sm font-semibold text-foreground transition-all hover:border-foreground hover:bg-surface-2"
              >
